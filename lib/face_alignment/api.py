...
from lib.face_alignment.models import FAN, ResNetDepth
from lib.face_alignment.utils import *
...
class FaceAlignment:
    ...
    def __init__(self, enable_cuda=True, enable_cudnn=True, use_cnn_face_detector=False):
        ...
        base_path = './lib/face_alignment/data/'
    ...
    def get_landmarks(self, input_image):
        with torch.no_grad():
            ...
            return zip(detected_faces, landmarks)
